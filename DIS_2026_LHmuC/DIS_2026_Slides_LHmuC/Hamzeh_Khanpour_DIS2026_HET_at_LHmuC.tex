...
\justifying
\small
\item \LHCmu{} naturally operates as a high-energy $\gamma\gamma$ collider.% through photons radiated from the incoming muon and proton beams.
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{Syy.jpg}
\justifying \scriptsize Elastic photon-photon luminosity spectrum $S_{\gamma\gamma}$ as a function of the $\gamma\gamma$ invariant mass $W$, comparing the LHeC, LH$\mu$C, and FCC-$\mu h$ benchmark configurations.
\end{figure}
\end{column}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,height=0.73\textheight,keepaspectratio]{elastic_tau_tau.jpg}
\justifying\scriptsize Elastic $\gamma\gamma\to\tau^+\tau^-$ cross section above the threshold $W_0$, comparing the LHeC, LH$\mu$C, and FCC-$\mu h$ benchmark configurations.
\end{figure}
\end{column}
