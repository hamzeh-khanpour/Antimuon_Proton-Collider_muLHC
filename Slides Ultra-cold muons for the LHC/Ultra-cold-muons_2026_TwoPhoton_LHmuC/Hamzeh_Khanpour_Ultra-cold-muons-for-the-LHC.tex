...
\begin{alertblock}{Factorised $\gamma\gamma$ picture}
\footnotesize
...
%\item
%\textcolor{LHOrange}{\textbf{Tagged elastic}}
					
%The intact proton is measured in a near-beam detector.
%Its momentum loss provides an additional constraint on the
%photon momentum and on the central $\gamma\gamma$ system.
...
%\item
%\textbf{Acoplanarity and transverse-momentum balance}
%help distinguish elastic and dissociative photon-induced events
%from more inclusive backgrounds.
...
\item $a_\tau$: \textbf{CP-even} anomalous magnetic dipole moment.
\item $d_\tau$: \textbf{CP-odd} electric dipole moment.
...
\textbf{CP-even} production rate and differential distributions.
					
\item The electric dipole moment \(d_\tau\) is \textbf{CP-odd}; in
...
\item Both effects become more visible in the \textbf{hard kinematic regime},
