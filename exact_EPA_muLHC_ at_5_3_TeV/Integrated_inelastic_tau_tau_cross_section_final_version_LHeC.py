...
q2emax = 1000000.0  # Maximum photon virtuality for electron in GeV^2
q2pmax = 1000000.0  # Maximum photon virtuality for proton in GeV^2
...
# Save results with None handling and formatted filename
    filename = f"LHeC_Inelastic_Photon_Luminosity_Spectrum_MNmax_{int(MN_max)}_q2emax_{int(q2emax)}_q2pmax_{int(q2pmax)}.txt"
...
# Construct filenames for the plots including MN_max, q2emax, and q2pmax
    plot_filename_pdf = f"LHeC_Inelastic_Photon_Luminosity_Spectrum_MNmax_{int(MN_max)}_q2emax_{int(q2emax)}_q2pmax_{int(q2pmax)}.pdf"
    plot_filename_jpg = f"LHeC_Inelastic_Photon_Luminosity_Spectrum_MNmax_{int(MN_max)}_q2emax_{int(q2emax)}_q2pmax_{int(q2pmax)}.jpg"
