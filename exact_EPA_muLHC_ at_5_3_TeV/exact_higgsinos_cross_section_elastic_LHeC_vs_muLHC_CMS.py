...
#
# Outputs:
#   - exact_higgsinos_cross_section_elastic_LHeC_vs_muLHC_CMS.pdf/.png
#   - exact_higgsinos_cross_section_elastic_LHeC_vs_muLHC.txt  (W0, sigma_LHeC[pb], sigma_muLHC[pb])
...
Wmin = max(W0_e.min(),  W0_mu.min(),  10.0)
Wmax = min(W0_e.max(),  W0_mu.max(),  1000.0)
...
# ---------------- Save the numbers ----------------
out_txt = "exact_higgsinos_cross_section_elastic_LHeC_vs_muLHC_4TeV.txt"
np.savetxt(out_txt,
...
plt.savefig("exact_higgsinos_cross_section_elastic_LHeC_vs_muLHC_4TeV.pdf")
plt.savefig("exact_higgsinos_cross_section_elastic_LHeC_vs_muLHC_4TeV.png", dpi=300)
plt.show()
