...
#
# Outputs:
#   - exact_tautau_cross_section_elastic_LHeC_vs_muLHC_CMS.pdf/.png
#   - exact_tautau_cross_section_elastic_LHeC_vs_muLHC.txt  (W0, sigma_LHeC[pb], sigma_muLHC[pb])
...
# ---------------- Save the numbers ----------------
out_txt = "exact_tautau_cross_section_elastic_LHeC_vs_muLHC_4TeV.txt"
np.savetxt(out_txt,
...
plt.savefig("exact_tautau_cross_section_elastic_LHeC_vs_muLHC_4TeV.pdf")
plt.savefig("exact_tautau_cross_section_elastic_LHeC_vs_muLHC_4TeV.png", dpi=300)
plt.show()
