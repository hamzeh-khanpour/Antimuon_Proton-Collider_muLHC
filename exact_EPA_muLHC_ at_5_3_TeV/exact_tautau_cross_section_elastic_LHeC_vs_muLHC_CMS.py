...
# ---------------- Save the numbers ----------------
out_txt = "exact_tautau_cross_section_elastic_LHeC_vs_muLHC.txt"
np.savetxt(out_txt,
...
plt.savefig("exact_tautau_cross_section_elastic_LHeC_vs_muLHC_CMS.pdf")
plt.savefig("exact_tautau_cross_section_elastic_LHeC_vs_muLHC_CMS.png", dpi=300)
plt.show()
