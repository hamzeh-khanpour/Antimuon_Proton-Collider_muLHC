...
m_w_hadronic_leptonic_range = (160, 1600)
...
# Lepton pT
plt.step(pt_bins_signal_0, dsigma_signal_pt_0, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4=+1$]", linewidth=3)
plt.step(pt_bins_signal_2, dsigma_signal_pt_2, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4=-1$]", linewidth=3)
plt.step(pt_bins_background, dsigma_background_pt, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : SM background ($w^+ w^-$)", linewidth=3)
...
plt.yscale("log"); plt.legend(); plt.grid(True, linestyle="--", alpha=0.6); plt.tight_layout(); plt.savefig("differential_cross_section_pt_lepton_μLHC.pdf", dpi=600)
plt.show()
...
# Eta
plt.step(eta_bins_signal_0, dsigma_signal_eta_0, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4$]", linewidth=3)
plt.step(eta_bins_signal_2, dsigma_signal_eta_2, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4$]", linewidth=3)
plt.step(eta_bins_background, dsigma_background_eta, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : SM background ($w^+ w^-$)", linewidth=3)
...
# Leading jet pT
plt.step(pt_jet_bins_signal_0, dsigma_signal_jet_pt_0, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4=+1$]", linewidth=3)
plt.step(pt_jet_bins_signal_2, dsigma_signal_jet_pt_2, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4=-1$]", linewidth=3)
plt.step(pt_jet_bins_background, dsigma_background_jet_pt, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : SM background ($w^+ w^-$)", linewidth=3)
plt.xlabel(r"$p_T^{\mathrm{leading~jet}} \ \mathrm{[GeV]}$"); plt.ylabel(r"$\frac{d\sigma}{dp_T^{\mathrm{leading~jet}}} \ \mathrm{[pb/GeV]}$")
plt.title(r"$e^- p \to e^- w^+ w^- p \to e^- j j \ell \nu_{\ell} p$ : μLHC@3.7 TeV", fontsize=24)
plt.yscale("log"); plt.legend(); plt.grid(True, linestyle="--", alpha=0.6); plt.tight_layout(); plt.savefig("differential_cross_section_leading_jet_pt_μLHC.pdf", dpi=600)
plt.show()
...
# ΔR
plt.step(delta_r_bins_signal_0, dsigma_signal_delta_r_0, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4$]", linewidth=3)
plt.step(delta_r_bins_signal_2, dsigma_signal_delta_r_2, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4$]", linewidth=3)
plt.step(delta_r_bins_background, dsigma_background_delta_r, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : SM background ($w^+ w^-$)", linewidth=3)
...
plt.step(m_w_hadronic_leptonic_bins_signal_0, dsigma_signal_m_w_hadronic_leptonic_0, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4=+1$]", linewidth=3)
plt.step(m_w_hadronic_leptonic_bins_signal_2, dsigma_signal_m_w_hadronic_leptonic_2, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : Signal ($w^+ w^-$) [$f_{M_2}/\Lambda^4=-1$]", linewidth=3)
plt.step(m_w_hadronic_leptonic_bins_background, dsigma_background_m_w_hadronic_leptonic, where="mid", alpha=0.7, label=r"μLHC@3.7 TeV : SM background ($w^+ w^-$)", linewidth=3)
plt.xlabel(r"$M_{WW} \ \mathrm{[GeV]}$"); plt.ylabel(r"$\frac{d\sigma}{dM_{WW}} \ \mathrm{[pb/GeV]}$")
plt.title(r"$e^- p \to e^- w^+ w^- p \to e^- j j \ell \nu_{\ell} p$ : μLHC@3.7 TeV", fontsize=24)
plt.yscale("log"); plt.legend(); plt.grid(True, linestyle="--", alpha=0.6); plt.tight_layout(); plt.savefig("normalized_cross_section_m_ww_reco_μLHC.pdf", dpi=600)
plt.show()
...
SHAPE_CUTS = [(400.0, None), (500.0, None), (600.0, None), (700.0, None), (800.0, None),
              (900.0, None), (1000.0, None), (1200.0, None), (1400.0, None)]
