...
signal_file_0 = "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/muLHC_EFT_aa_ww_semi_leptonic/Events/run_03/muLHC_EFT_aa_ww_semi_leptonic.lhe"
signal_file_2 = "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/muLHC_EFT_aa_ww_semi_leptonic/Events/run_04/muLHC_EFT_aa_ww_semi_leptonic.lhe"


background_file = "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/muLHC_SM_aa_ww_semi_leptonic/Events/run_02/muLHC_SM_aa_ww_semi_leptonic.lhe"
...
# 1   NP = 1
signal_cross_section_0    = 0.114233     # pb  FM2 =  0.1
signal_cross_section_2    = 0.114259     # pb  FM2 = -0.1

background_cross_section  = 0.113777    # pb
...
met_range = (1, 600)              # Define range for MET (adjust as needed)
...
m_w_hadronic_leptonic_range = (160, 3600)  # WW invariant mass; threshold ~ 2*mW up to ~μLHC √s_γγ
...
plt.step(pt_bins_signal_0, dsigma_signal_pt_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4=+0.1$]", color="red", linewidth=3)
plt.step(pt_bins_signal_2, dsigma_signal_pt_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4=-0.1$]", color="green", linewidth=3)
plt.step(pt_bins_background, dsigma_background_pt, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
plt.xlabel(r"$p_T^{\ell} \ \mathrm{[GeV]}$")
plt.ylabel(r"$\frac{d\sigma}{dp_T^{\ell}} \ \mathrm{[pb/GeV]}$")
plt.title(r"$e^- p \to e^- w^+ w^- p \to e^- j j \ell \nu_{\ell} p$ : μLHC@7.5 TeV", fontsize=24)
plt.yscale("log")
plt.legend()
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plt.ylim(0.0000001, 0.01)
plt.savefig("differential_cross_section_pt_μLHC_at_7_5_TeV.pdf", dpi=600)
plt.show()
...
plt.step(eta_bins_signal_0, dsigma_signal_eta_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="red", linewidth=3)
plt.step(eta_bins_signal_2, dsigma_signal_eta_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(eta_bins_background, dsigma_background_eta, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
#plt.savefig("differential_cross_section_eta_lepton_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(pt_jet_bins_signal_0, dsigma_signal_jet_pt_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4=+0.1$]", color="red", linewidth=3)
plt.step(pt_jet_bins_signal_2, dsigma_signal_jet_pt_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4=-0.1$]", color="green", linewidth=3)
plt.step(pt_jet_bins_background, dsigma_background_jet_pt, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plt.savefig("differential_cross_section_leading_jet_pt_μLHC_at_7_5_TeV.pdf", dpi=600)
plt.show()
...
plt.step(delta_r_bins_signal_0, dsigma_signal_delta_r_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="red", linewidth=3)
plt.step(delta_r_bins_signal_2, dsigma_signal_delta_r_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(delta_r_bins_background, dsigma_background_delta_r, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
#plt.savefig("differential_cross_section_delta_r_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(met_bins_signal_0, dsigma_signal_met_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4=+0.1$]", color="red", linewidth=3)
plt.step(met_bins_signal_2, dsigma_signal_met_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4=-0.1$]", color="green", linewidth=3)
plt.step(met_bins_background, dsigma_background_met, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.tight_layout()
plt.ylim(0.0000001, 0.01)
plt.savefig("differential_cross_section_met_μLHC_at_7_5_TeV.pdf", dpi=600)
plt.show()
...
plt.step(centrality_bins_signal_0, dsigma_signal_centrality_0_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="red", linewidth=3)
plt.step(centrality_bins_signal_2, dsigma_signal_centrality_2_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(centrality_bins_background, dsigma_background_centrality_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.tight_layout()
#plt.savefig("normalized_distribution_eta_leading_jet_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(centrality_bins_signal_0, dsigma_signal_centrality_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="red", linewidth=3)
plt.step(centrality_bins_signal_2, dsigma_signal_centrality_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(centrality_bins_background, dsigma_background_centrality, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
plt.xlabel(r"$\eta_{leading \; jet}$")
...
plt.tight_layout()
#plt.savefig("differential_cross_section_eta_leading_jet_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(exp_centrality_bins_signal_0, dsigma_signal_exp_centrality_0_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="red", linewidth=3)
plt.step(exp_centrality_bins_signal_2, dsigma_signal_exp_centrality_2_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="green", linewidth=3)
plt.step(exp_centrality_bins_background, dsigma_background_exp_centrality_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
# Axis labels and title
plt.xlabel(r"$C_{\ell}^{\mathrm{exp}}$")
plt.ylabel("Normalized Distribution")
plt.title(r"$e^- p \to e^- w^+ w^- p \to e^- j j \ell \nu_{\ell} p$ : μLHC@7.5 TeV", fontsize=24)
plt.yscale("log")
plt.ylim(1e-6, 1.0)  # Adjust as needed for log scale
# Add legend, grid, and formula
plt.legend()
plt.grid(True, linestyle="--", alpha=0.6)
...
# Save and display the plot
plt.tight_layout()
#plt.savefig("normalized_distribution_exp_centrality_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(exp_centrality_bins_signal_0, dsigma_signal_exp_centrality_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="red", linewidth=3)
plt.step(exp_centrality_bins_signal_2, dsigma_signal_exp_centrality_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(exp_centrality_bins_background, dsigma_background_exp_centrality, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
plt.xlabel(r"$C_{\ell}^{\mathrm{exp}}$")
...
plt.tight_layout()
#plt.savefig("differential_cross_section_exp_centrality_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(jet_centrality_bins_signal_0, dsigma_signal_jet_centrality_0_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="red", linewidth=3)
plt.step(jet_centrality_bins_signal_2, dsigma_signal_jet_centrality_2_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="green", linewidth=3)
plt.step(jet_centrality_bins_background, dsigma_background_jet_centrality_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
# Axis labels and title
...
# Save and display the plot
plt.tight_layout()
#plt.savefig("normalized_distribution_jet_centrality_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(jet_centrality_bins_signal_0, dsigma_signal_jet_centrality_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="red", linewidth=3)
plt.step(jet_centrality_bins_signal_2, dsigma_signal_jet_centrality_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="green", linewidth=3)
plt.step(jet_centrality_bins_background, dsigma_background_jet_centrality, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
plt.xlabel(r"$C_{\mathrm{jets}}$")
...
plt.tight_layout()
#plt.savefig("differential_cross_section_jet_centrality_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(delta_eta_jj_bins_signal_0, dsigma_signal_delta_eta_jj_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="red", linewidth=3)
plt.step(delta_eta_jj_bins_signal_2, dsigma_signal_delta_eta_jj_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="green", linewidth=3)
plt.step(delta_eta_jj_bins_background, dsigma_background_delta_eta_jj, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
#plt.savefig("differential_cross_section_eta_subleading_jet_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(m_w_hadronic_bins_signal_0, dsigma_signal_m_w_hadronic_0_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="red", linewidth=3)
plt.step(m_w_hadronic_bins_signal_2, dsigma_signal_m_w_hadronic_2_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="green", linewidth=3)
plt.step(m_w_hadronic_bins_background, dsigma_background_m_w_hadronic_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
#plt.savefig("normalized_cross_section_m_w_hadronic_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(m_w_hadronic_bins_signal_0, dsigma_signal_m_w_hadronic_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="red", linewidth=3)
plt.step(m_w_hadronic_bins_signal_2, dsigma_signal_m_w_hadronic_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="green", linewidth=3)
plt.step(m_w_hadronic_bins_background, dsigma_background_m_w_hadronic, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
plt.xlabel(r"$M_W^{jj} \ \mathrm{[GeV]}$")
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
#plt.savefig("differential_cross_section_m_w_hadronic_μLHC.pdf", dpi=600)
plt.show()
...
#plt.figure(figsize=(10, 8))
plt.step(m_w_leptonic_bins_signal_0, dsigma_signal_m_w_leptonic_0_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="red", linewidth=3)
plt.step(m_w_leptonic_bins_signal_2, dsigma_signal_m_w_leptonic_2_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="green", linewidth=3)
plt.step(m_w_leptonic_bins_background, dsigma_background_m_w_leptonic_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
#plt.savefig("normalized_cross_section_m_w_leptonic_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(m_w_leptonic_bins_signal_0, dsigma_signal_m_w_leptonic_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="red", linewidth=3)
plt.step(m_w_leptonic_bins_signal_2, dsigma_signal_m_w_leptonic_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$)", color="green", linewidth=3)
plt.step(m_w_leptonic_bins_background, dsigma_background_m_w_leptonic, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
plt.xlabel(r"$M_W^{\ell\nu_{\ell}} \ \mathrm{[GeV]}$")
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
#plt.savefig("differential_cross_section_m_w_leptonic_μLHC.pdf", dpi=600)
plt.show()
...
plt.step(m_w_hadronic_leptonic_bins_signal_0, dsigma_signal_m_w_hadronic_leptonic_0_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \\Lambda^4=+0.1$)", color="red", linewidth=3)
plt.step(m_w_hadronic_leptonic_bins_signal_2, dsigma_signal_m_w_hadronic_leptonic_2_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \\Lambda^4=-0.1$)", color="green", linewidth=3)
plt.step(m_w_hadronic_leptonic_bins_background, dsigma_background_m_w_hadronic_leptonic_norm, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plt.savefig("normalized_cross_section_m_ww_reco_μLHC_at_7_5_TeV.pdf", dpi=600)
plt.show()
...
plt.step(m_w_hadronic_leptonic_bins_signal_0, dsigma_signal_m_w_hadronic_leptonic_0, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \\Lambda^4=+0.1$)", color="red", linewidth=3)
plt.step(m_w_hadronic_leptonic_bins_signal_2, dsigma_signal_m_w_hadronic_leptonic_2, where="mid", alpha=0.7, label="μLHC@7.5 TeV : Signal ($w^+ w^-) [f_{M_2} / \\Lambda^4=-0.1$)", color="green", linewidth=3)
plt.step(m_w_hadronic_leptonic_bins_background, dsigma_background_m_w_hadronic_leptonic, where="mid", alpha=0.7, label="μLHC@7.5 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plt.savefig("differential_cross_section_m_ww_reco_μLHC_at_7_5_TeV.pdf", dpi=600)
plt.show()
...
# =============================================================================
# Tail σ(MWW>W_cut) and 95% CL limits (counting, Asimov exact) using f=0, +1, −1 for μLHC
# =============================================================================
...
# --- Config
THRESHOLDS = [400.0, 500.0, 600.0, 700.0, 800.0, 900.0, 1000.0, 1200.0, 1400.0, 1600, 1800, 2000, 2200, 2400, 2600, 2800, 3000]  # GeV
L_fb = 1000.0     # integrated luminosity in fb^-1
Aeps = 1.0        # acceptance × efficiency
PB_TO_FB = 1e3    # 1 pb = 1000 fb
f0 = 0.1         # TeV^-4  (your MG couplings are ±1)
...
row_p  = [integrate_tail_hist(dsigma_signal_m_w_hadronic_leptonic_0, edges_mww, thr)   for thr in THRESHOLDS]  # f=+0.1
...
hdr = "cut  ".ljust(8) + "σ_SM      σ(+0.1)    σ(−0.1)    ".ljust(32) + "N_SM@1000fb  N(+0.1)@1000fb  N(−0.1)@1000fb"
print(hdr)
print("-"*len(hdr))
...
SHAPE_CUTS = [(400.0, None), (500.0, None), (600.0, None), (700.0, None), (800.0, None), (900.0, None), (1000.0, None), (1200.0, None), (1400.0, None),
              (1600.0, None), (1800.0, None), (2000.0, None), (2200.0, None), (2400.0, None), (2600.0, None), (2800.0, None), (3000.0, None)]
