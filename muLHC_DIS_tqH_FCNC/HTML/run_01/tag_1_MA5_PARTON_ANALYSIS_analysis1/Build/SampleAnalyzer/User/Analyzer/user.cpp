                      ...
                      const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddHisto("13_M", 40,0.0,500.0);
  ...
  Manager()->AddHisto("27_DELTAR", 40,0.0,10.0);
  Manager()->AddHisto("28_DELTAR", 40,0.0,10.0);
...
MAbool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("6_PT", _P_p_I1I_PTorderingfinalstate_REG_[ind[0]]->pt());
    }
  }
  }
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_p_I1I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
      Manager()->FillHisto("7_ETA", _P_p_I1I_PTorderingfinalstate_REG_[ind[0]]->eta());
    }
  }
  }
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("8_PT", _P_t_I1I_PTorderingfinalstate_REG_[ind[0]]->pt());
    }
  }
  }
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_t_I1I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
      Manager()->FillHisto("9_ETA", _P_t_I1I_PTorderingfinalstate_REG_[ind[0]]->eta());
    }
  }
  }
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("10_PT", _P_h_I1I_PTorderingfinalstate_REG_[ind[0]]->pt());
    }
  }
  }
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_h_I1I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
      Manager()->FillHisto("11_ETA", _P_h_I1I_PTorderingfinalstate_REG_[ind[0]]->eta());
    }
  }
  }
  ...
  {
  {
    ...
    q+=_P_h_I1I_PTorderingfinalstate_REG_[ind[0]]->momentum();
  ...
  {
  {
    ...
    for (ind[1]=0;ind[1]<_P_p_I1I_PTorderingfinalstate_REG_.size();ind[1]++)
    {
    for (ind[2]=0;ind[2]<_P_t_I1I_PTorderingfinalstate_REG_.size();ind[2]++)
    {
    ParticleBaseFormat q;
    q+=_P_mu_p_I1I_PTorderingfinalstate_REG_[ind[0]]->momentum();
    q+=_P_p_I1I_PTorderingfinalstate_REG_[ind[1]]->momentum();
    q+=_P_t_I1I_PTorderingfinalstate_REG_[ind[2]]->momentum();
  ...
  {
  {
    ...
    for (ind[2]=0;ind[2]<_P_p_I1I_PTorderingfinalstate_REG_.size();ind[2]++)
    {
    for (ind[3]=0;ind[3]<_P_t_I1I_PTorderingfinalstate_REG_.size();ind[3]++)
    {
    ParticleBaseFormat q;
    q+=_P_h_I1I_PTorderingfinalstate_REG_[ind[0]]->momentum();
    q+=_P_mu_p_I1I_PTorderingfinalstate_REG_[ind[1]]->momentum();
    q+=_P_p_I1I_PTorderingfinalstate_REG_[ind[2]]->momentum();
    q+=_P_t_I1I_PTorderingfinalstate_REG_[ind[3]]->momentum();
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_mu_p_I1I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
    for (ind[1]=0;ind[1]<_P_t_I1I_PTorderingfinalstate_REG_.size();ind[1]++)
    {
    ParticleBaseFormat q;
    q+=_P_mu_p_I1I_PTorderingfinalstate_REG_[ind[0]]->momentum();
    q+=_P_t_I1I_PTorderingfinalstate_REG_[ind[1]]->momentum();
  ...
  {
  {
    ...
    {
    MAuint32 b[1];
    for (b[0]=0;b[0]<_P_h_I1I_PTorderingfinalstate_REG_.size();b[0]++)
    {
      Manager()->FillHisto("23_DELTAR", _P_mu_p_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_h_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("24_DELTAR", _P_mu_p_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_p_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("25_DELTAR", _P_mu_p_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_t_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    for (b[0]=0;b[0]<_P_h_I1I_PTorderingfinalstate_REG_.size();b[0]++)
    {
      Manager()->FillHisto("26_DELTAR", _P_p_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_h_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    for (b[0]=0;b[0]<_P_t_I1I_PTorderingfinalstate_REG_.size();b[0]++)
    {
      Manager()->FillHisto("27_DELTAR", _P_p_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_t_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
    MAuint32 a[1];
    for (a[0]=0;a[0]<_P_t_I1I_PTorderingfinalstate_REG_.size();a[0]++)
    {
    MAuint32 b[1];
    for (b[0]=0;b[0]<_P_h_I1I_PTorderingfinalstate_REG_.size();b[0]++)
    {
      Manager()->FillHisto("28_DELTAR", _P_t_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_h_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
