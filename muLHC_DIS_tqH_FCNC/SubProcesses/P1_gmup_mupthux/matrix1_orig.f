...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL IXXXXX(P(0,6),MDL_MU,NHEL(6),-1*IC(6),W(1,6))
      CALL FFV1_1(W(1,4),W(1,1),GC_7(IVEC),MDL_MT, ZERO,W(1,7))
      CALL FFS3_3(W(1,3),W(1,2),GC_79,MDL_MH, ZERO,W(1,8))
      CALL FFS1_2_1(W(1,7),W(1,5),GC_16,GC_12,MDL_MU, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,6),W(1,9),W(1,8),GC_83,AMP(1))
      CALL FFS3_1(W(1,7),W(1,5),GC_81,MDL_MT, ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFS1_2_0(W(1,6),W(1,10),W(1,8),GC_16,GC_12,AMP(2))
      CALL FFS1_2_3(W(1,6),W(1,7),GC_16,GC_12,MDL_MH, ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL SSS1_0(W(1,8),W(1,5),W(1,11),GC_72,AMP(3))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_3,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,9),W(1,12),GC_2,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV3_9_0(W(1,6),W(1,10),W(1,12),GC_25,GC_21,AMP(5))
      CALL FFV2_7_3(W(1,3),W(1,2),GC_62,GC_69,MDL_MZ, ZERO,W(1,13))
C     Amplitude(s) for diagram number 6
      CALL FFV2_8_0(W(1,6),W(1,9),W(1,13),GC_63,GC_68,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_3_5_9_0(W(1,6),W(1,10),W(1,13),GC_43,GC_40,GC_47,GC_36
     $ ,AMP(7))
      CALL FFV2_3_5_9_3(W(1,6),W(1,7),GC_43,GC_40,GC_47,GC_36,MDL_MZ,
     $  ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL VVS1_0(W(1,13),W(1,10),W(1,5),GC_74,AMP(8))
      CALL FFV3_9_1(W(1,4),W(1,1),GC_33(IVEC),GC_29(IVEC),MDL_MU,
     $  FK_ZERO,W(1,9))
      CALL FFS3_1(W(1,9),W(1,5),GC_83,MDL_MU, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 9
      CALL FFS3_0(W(1,6),W(1,14),W(1,8),GC_83,AMP(9))
      CALL FFS3_3(W(1,6),W(1,9),GC_83,MDL_MH, ZERO,W(1,15))
C     Amplitude(s) for diagram number 10
      CALL SSS1_0(W(1,8),W(1,5),W(1,15),GC_72,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,6),W(1,14),W(1,12),GC_2,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_8_0(W(1,6),W(1,14),W(1,13),GC_63,GC_68,AMP(12))
      CALL FFV2_8_3(W(1,6),W(1,9),GC_63,GC_68,MDL_MZ, ZERO,W(1,14))
C     Amplitude(s) for diagram number 13
      CALL VVS1_0(W(1,13),W(1,14),W(1,5),GC_74,AMP(13))
      CALL FFS1_2_2(W(1,6),W(1,5),GC_16,GC_12,MDL_MT, FK_MDL_WT,W(1,16)
     $ )
C     Amplitude(s) for diagram number 14
      CALL FFS3_0(W(1,16),W(1,7),W(1,8),GC_81,AMP(14))
      CALL FFS3_2(W(1,6),W(1,5),GC_83,MDL_MU, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 15
      CALL FFS1_2_0(W(1,17),W(1,7),W(1,8),GC_16,GC_12,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,16),W(1,7),W(1,12),GC_2,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV3_9_0(W(1,17),W(1,7),W(1,12),GC_25,GC_21,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_8_0(W(1,16),W(1,7),W(1,13),GC_63,GC_68,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_3_5_9_0(W(1,17),W(1,7),W(1,13),GC_43,GC_40,GC_47,GC_36
     $ ,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFS3_0(W(1,17),W(1,9),W(1,8),GC_83,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,17),W(1,9),W(1,12),GC_2,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_8_0(W(1,17),W(1,9),W(1,13),GC_63,GC_68,AMP(22))
      CALL FFS3_1(W(1,2),W(1,5),GC_79,MDL_MMU, FK_ZERO,W(1,18))
C     Amplitude(s) for diagram number 23
      CALL FFS3_0(W(1,3),W(1,18),W(1,11),GC_79,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_7_0(W(1,3),W(1,18),W(1,10),GC_62,GC_69,AMP(24))
      CALL FFV3_9P0_3(W(1,6),W(1,7),GC_25,GC_21,ZERO, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,3),W(1,18),W(1,19),GC_3,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFS3_0(W(1,3),W(1,18),W(1,15),GC_79,AMP(26))
      CALL FFV1P0_3(W(1,6),W(1,9),GC_2,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,3),W(1,18),W(1,7),GC_3,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_7_0(W(1,3),W(1,18),W(1,14),GC_62,GC_69,AMP(28))
      CALL FFS3_2(W(1,3),W(1,5),GC_79,MDL_MMU, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 29
      CALL FFS3_0(W(1,9),W(1,2),W(1,11),GC_79,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_7_0(W(1,9),W(1,2),W(1,10),GC_62,GC_69,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,9),W(1,2),W(1,19),GC_3,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFS3_0(W(1,9),W(1,2),W(1,15),GC_79,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,9),W(1,2),W(1,7),GC_3,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_7_0(W(1,9),W(1,2),W(1,14),GC_62,GC_69,AMP(34))
      CALL FFV1_2(W(1,6),W(1,1),GC_7(IVEC),MDL_MU, FK_ZERO,W(1,14))
      CALL FFS1_2_3(W(1,14),W(1,4),GC_16,GC_12,MDL_MH, ZERO,W(1,7))
C     Amplitude(s) for diagram number 35
      CALL SSS1_0(W(1,8),W(1,5),W(1,7),GC_72,AMP(35))
      CALL FFS1_2_2(W(1,14),W(1,5),GC_16,GC_12,MDL_MT, ZERO,W(1,15))
C     Amplitude(s) for diagram number 36
      CALL FFS3_0(W(1,15),W(1,4),W(1,8),GC_81,AMP(36))
      CALL FFS3_2(W(1,14),W(1,5),GC_83,MDL_MU, FK_ZERO,W(1,19))
C     Amplitude(s) for diagram number 37
      CALL FFS1_2_0(W(1,19),W(1,4),W(1,8),GC_16,GC_12,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,15),W(1,4),W(1,12),GC_2,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV3_9_0(W(1,19),W(1,4),W(1,12),GC_25,GC_21,AMP(39))
      CALL FFV2_3_5_9_3(W(1,14),W(1,4),GC_43,GC_40,GC_47,GC_36,MDL_MZ,
     $  ZERO,W(1,10))
C     Amplitude(s) for diagram number 40
      CALL VVS1_0(W(1,13),W(1,10),W(1,5),GC_74,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV2_8_0(W(1,15),W(1,4),W(1,13),GC_63,GC_68,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV2_3_5_9_0(W(1,19),W(1,4),W(1,13),GC_43,GC_40,GC_47,GC_36
     $ ,AMP(42))
      CALL FFV3_9_2(W(1,6),W(1,1),GC_33(IVEC),GC_29(IVEC),MDL_MT, ZERO
     $ ,W(1,19))
      CALL FFS3_3(W(1,19),W(1,4),GC_81,MDL_MH, ZERO,W(1,15))
C     Amplitude(s) for diagram number 43
      CALL SSS1_0(W(1,8),W(1,5),W(1,15),GC_72,AMP(43))
      CALL FFS3_2(W(1,19),W(1,5),GC_81,MDL_MT, ZERO,W(1,11))
C     Amplitude(s) for diagram number 44
      CALL FFS3_0(W(1,11),W(1,4),W(1,8),GC_81,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,11),W(1,4),W(1,12),GC_2,AMP(45))
      CALL FFV2_8_3(W(1,19),W(1,4),GC_63,GC_68,MDL_MZ, ZERO,W(1,20))
C     Amplitude(s) for diagram number 46
      CALL VVS1_0(W(1,13),W(1,20),W(1,5),GC_74,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_8_0(W(1,11),W(1,4),W(1,13),GC_63,GC_68,AMP(47))
      CALL FFS1_2_1(W(1,4),W(1,5),GC_16,GC_12,MDL_MU, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 48
      CALL FFS3_0(W(1,14),W(1,11),W(1,8),GC_83,AMP(48))
      CALL FFS3_1(W(1,4),W(1,5),GC_81,MDL_MT, FK_MDL_WT,W(1,21))
C     Amplitude(s) for diagram number 49
      CALL FFS1_2_0(W(1,14),W(1,21),W(1,8),GC_16,GC_12,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,14),W(1,11),W(1,12),GC_2,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV3_9_0(W(1,14),W(1,21),W(1,12),GC_25,GC_21,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV2_8_0(W(1,14),W(1,11),W(1,13),GC_63,GC_68,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV2_3_5_9_0(W(1,14),W(1,21),W(1,13),GC_43,GC_40,GC_47
     $ ,GC_36,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFS3_0(W(1,19),W(1,21),W(1,8),GC_81,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,19),W(1,21),W(1,12),GC_2,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV2_8_0(W(1,19),W(1,21),W(1,13),GC_63,GC_68,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFS3_0(W(1,3),W(1,18),W(1,7),GC_79,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV2_7_0(W(1,3),W(1,18),W(1,10),GC_62,GC_69,AMP(58))
      CALL FFV3_9P0_3(W(1,14),W(1,4),GC_25,GC_21,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,3),W(1,18),W(1,5),GC_3,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFS3_0(W(1,3),W(1,18),W(1,15),GC_79,AMP(60))
      CALL FFV1P0_3(W(1,19),W(1,4),GC_2,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,3),W(1,18),W(1,14),GC_3,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV2_7_0(W(1,3),W(1,18),W(1,20),GC_62,GC_69,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFS3_0(W(1,9),W(1,2),W(1,7),GC_79,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV2_7_0(W(1,9),W(1,2),W(1,10),GC_62,GC_69,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,9),W(1,2),W(1,5),GC_3,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFS3_0(W(1,9),W(1,2),W(1,15),GC_79,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL FFV1_0(W(1,9),W(1,2),W(1,14),GC_3,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFV2_7_0(W(1,9),W(1,2),W(1,20),GC_62,GC_69,AMP(68))
      CALL FFV1_1(W(1,11),W(1,1),GC_7(IVEC),MDL_MU, FK_ZERO,W(1,20))
C     Amplitude(s) for diagram number 69
      CALL FFS3_0(W(1,6),W(1,20),W(1,8),GC_83,AMP(69))
      CALL FFV1_1(W(1,21),W(1,1),GC_7(IVEC),MDL_MT, ZERO,W(1,11))
C     Amplitude(s) for diagram number 70
      CALL FFS1_2_0(W(1,6),W(1,11),W(1,8),GC_16,GC_12,AMP(70))
      CALL FFV3_9_1(W(1,21),W(1,1),GC_33(IVEC),GC_29(IVEC),MDL_MU,
     $  FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 71
      CALL FFS3_0(W(1,6),W(1,9),W(1,8),GC_83,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV1_0(W(1,6),W(1,20),W(1,12),GC_2,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL FFV3_9_0(W(1,6),W(1,11),W(1,12),GC_25,GC_21,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,6),W(1,9),W(1,12),GC_2,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV2_8_0(W(1,6),W(1,20),W(1,13),GC_63,GC_68,AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFV2_3_5_9_0(W(1,6),W(1,11),W(1,13),GC_43,GC_40,GC_47,GC_36
     $ ,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV2_8_0(W(1,6),W(1,9),W(1,13),GC_63,GC_68,AMP(77))
      CALL FFV1_2(W(1,16),W(1,1),GC_7(IVEC),MDL_MT, ZERO,W(1,9))
C     Amplitude(s) for diagram number 78
      CALL FFS3_0(W(1,9),W(1,4),W(1,8),GC_81,AMP(78))
      CALL FFV1_2(W(1,17),W(1,1),GC_7(IVEC),MDL_MU, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 79
      CALL FFS1_2_0(W(1,16),W(1,4),W(1,8),GC_16,GC_12,AMP(79))
      CALL FFV3_9_2(W(1,17),W(1,1),GC_33(IVEC),GC_29(IVEC),MDL_MT,
     $  ZERO,W(1,6))
C     Amplitude(s) for diagram number 80
      CALL FFS3_0(W(1,6),W(1,4),W(1,8),GC_81,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,9),W(1,4),W(1,12),GC_2,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV3_9_0(W(1,16),W(1,4),W(1,12),GC_25,GC_21,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,6),W(1,4),W(1,12),GC_2,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_8_0(W(1,9),W(1,4),W(1,13),GC_63,GC_68,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV2_3_5_9_0(W(1,16),W(1,4),W(1,13),GC_43,GC_40,GC_47,GC_36
     $ ,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_8_0(W(1,6),W(1,4),W(1,13),GC_63,GC_68,AMP(86))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +AMP(80)+AMP(81)+AMP(82)+AMP(83)+AMP(84)+AMP(85)+AMP(86)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        AMP2(1)=AMP2(1)+(AMP(1)+AMP(4)+AMP(6))*DCONJG(AMP(1)+AMP(4)
     $   +AMP(6))
        AMP2(2)=AMP2(2)+(AMP(2)+AMP(5)+AMP(7))*DCONJG(AMP(2)+AMP(5)
     $   +AMP(7))
        AMP2(3)=AMP2(3)+(AMP(3)+AMP(8))*DCONJG(AMP(3)+AMP(8))
        AMP2(9)=AMP2(9)+(AMP(9)+AMP(11)+AMP(12))*DCONJG(AMP(9)+AMP(11)
     $   +AMP(12))
        AMP2(10)=AMP2(10)+(AMP(10)+AMP(13))*DCONJG(AMP(10)+AMP(13))
        AMP2(14)=AMP2(14)+(AMP(14)+AMP(16)+AMP(18))*DCONJG(AMP(14)
     $   +AMP(16)+AMP(18))
        AMP2(15)=AMP2(15)+(AMP(15)+AMP(17)+AMP(19))*DCONJG(AMP(15)
     $   +AMP(17)+AMP(19))
     ...
     $   +AMP(27)+AMP(28))
        AMP2(29)=AMP2(29)+(AMP(29)+AMP(30)+AMP(31))*DCONJG(AMP(29)
     $   +AMP(30)+AMP(31))
        AMP2(32)=AMP2(32)+(AMP(32)+AMP(33)+AMP(34))*DCONJG(AMP(32)
     $   +AMP(33)+AMP(34))
        AMP2(35)=AMP2(35)+(AMP(35)+AMP(40))*DCONJG(AMP(35)+AMP(40))
        AMP2(36)=AMP2(36)+(AMP(36)+AMP(38)+AMP(41))*DCONJG(AMP(36)
     $   +AMP(38)+AMP(41))
        AMP2(37)=AMP2(37)+(AMP(37)+AMP(39)+AMP(42))*DCONJG(AMP(37)
     $   +AMP(39)+AMP(42))
        AMP2(43)=AMP2(43)+(AMP(43)+AMP(46))*DCONJG(AMP(43)+AMP(46))
        AMP2(44)=AMP2(44)+(AMP(44)+AMP(45)+AMP(47))*DCONJG(AMP(44)
     $   +AMP(45)+AMP(47))
        AMP2(48)=AMP2(48)+(AMP(48)+AMP(50)+AMP(52))*DCONJG(AMP(48)
     $   +AMP(50)+AMP(52))
        AMP2(49)=AMP2(49)+(AMP(49)+AMP(51)+AMP(53))*DCONJG(AMP(49)
     $   +AMP(51)+AMP(53))
        AMP2(54)=AMP2(54)+(AMP(54)+AMP(55)+AMP(56))*DCONJG(AMP(54)
     $   +AMP(55)+AMP(56))
        AMP2(57)=AMP2(57)+(AMP(57)+AMP(58)+AMP(59))*DCONJG(AMP(57)
     $   +AMP(58)+AMP(59))
        AMP2(60)=AMP2(60)+(AMP(60)+AMP(61)+AMP(62))*DCONJG(AMP(60)
     $   +AMP(61)+AMP(62))
        AMP2(63)=AMP2(63)+(AMP(63)+AMP(64)+AMP(65))*DCONJG(AMP(63)
     $   +AMP(64)+AMP(65))
        AMP2(66)=AMP2(66)+(AMP(66)+AMP(67)+AMP(68))*DCONJG(AMP(66)
     $   +AMP(67)+AMP(68))
        AMP2(69)=AMP2(69)+(AMP(69)+AMP(72)+AMP(75))*DCONJG(AMP(69)
     $   +AMP(72)+AMP(75))
        AMP2(70)=AMP2(70)+(AMP(70)+AMP(73)+AMP(76))*DCONJG(AMP(70)
     $   +AMP(73)+AMP(76))
        AMP2(71)=AMP2(71)+(AMP(71)+AMP(74)+AMP(77))*DCONJG(AMP(71)
     $   +AMP(74)+AMP(77))
        AMP2(78)=AMP2(78)+(AMP(78)+AMP(81)+AMP(84))*DCONJG(AMP(78)
     $   +AMP(81)+AMP(84))
        AMP2(79)=AMP2(79)+(AMP(79)+AMP(82)+AMP(85))*DCONJG(AMP(79)
     $   +AMP(82)+AMP(85))
        AMP2(80)=AMP2(80)+(AMP(80)+AMP(83)+AMP(86))*DCONJG(AMP(80)
     $   +AMP(83)+AMP(86))
      ENDIF
