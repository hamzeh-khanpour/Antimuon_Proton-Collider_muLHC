...
MAbool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("4_PT", _P_t_I1I_PTorderingfinalstate_REG_[ind[0]]->pt());
    }
  }
  }
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_t_I1I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
      Manager()->FillHisto("5_ETA", _P_t_I1I_PTorderingfinalstate_REG_[ind[0]]->eta());
    }
  }
  }
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("9_DELTAR", _P_t_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_mu_p_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
