...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      CALL FFS1_2_3(W(1,1),W(1,7),GC_14,GC_10,MDL_MH,ZERO,W(1,9))  !  count 4
      CALL FFS1_2_3(W(1,1),W(1,8),GC_14,GC_10,MDL_MH,ZERO,W(1,10))  !  count 4
      CALL FFS1_2_3(W(1,2),W(1,7),GC_14,GC_10,MDL_MH,ZERO,W(1,11))  !  count 4
      CALL FFS1_2_3(W(1,2),W(1,8),GC_14,GC_10,MDL_MH,ZERO,W(1,12))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_5_9_3(W(1,1),W(1,7),GC_41,GC_38,GC_45,GC_34,MDL_MZ,ZER
     $O,W(1,13))  !  count 4
      CALL FFV2_3_5_9_3(W(1,1),W(1,8),GC_41,GC_38,GC_45,GC_34,MDL_MZ,ZER
     $O,W(1,14))  !  count 4
      CALL FFV2_3_5_9_3(W(1,2),W(1,7),GC_41,GC_38,GC_45,GC_34,MDL_MZ,ZER
     $O,W(1,15))  !  count 4
      CALL FFV2_3_5_9_3(W(1,2),W(1,8),GC_41,GC_38,GC_45,GC_34,MDL_MZ,ZER
     $O,W(1,16))  !  count 4
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV3_9P0_3(W(1,1),W(1,7),GC_23,GC_19,ZERO,FK_ZERO,W(1,17))  !  count 4
      CALL FFV3_9P0_3(W(1,1),W(1,8),GC_23,GC_19,ZERO,FK_ZERO,W(1,18))  !  count 4
      CALL FFV3_9P0_3(W(1,2),W(1,7),GC_23,GC_19,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV3_9P0_3(W(1,2),W(1,8),GC_23,GC_19,ZERO,FK_ZERO,W(1,20))  !  count 4
