...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      CALL OXXXXX(P(0,2),MDL_MMU,-1,-1*IC(2),W(1,4))  !  count 24
      CALL IXXXXX(P(0,3),MDL_MMU,+1,-1*IC(3),W(1,5))  !  count 24
      CALL IXXXXX(P(0,3),MDL_MMU,-1,-1*IC(3),W(1,6))  !  count 24
      CALL OXXXXX(P(0,4),MDL_MT,+1,+1*IC(4),W(1,7))  !  count 6
      CALL OXXXXX(P(0,4),MDL_MT,-1,+1*IC(4),W(1,8))  !  count 6
      CALL FFS1_2_3(W(1,1),W(1,7),GC_16,GC_12,MDL_MH,ZERO,W(1,9))  !  count 4
      CALL FFS1_2_3(W(1,1),W(1,8),GC_16,GC_12,MDL_MH,ZERO,W(1,10))  !  count 4
      CALL FFS1_2_3(W(1,2),W(1,7),GC_16,GC_12,MDL_MH,ZERO,W(1,11))  !  count 4
      CALL FFS1_2_3(W(1,2),W(1,8),GC_16,GC_12,MDL_MH,ZERO,W(1,12))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_5_9_3(W(1,1),W(1,7),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZER
     $O,W(1,13))  !  count 4
      CALL FFV2_3_5_9_3(W(1,1),W(1,8),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZER
     $O,W(1,14))  !  count 4
      CALL FFV2_3_5_9_3(W(1,2),W(1,7),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZER
     $O,W(1,15))  !  count 4
      CALL FFV2_3_5_9_3(W(1,2),W(1,8),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZER
     $O,W(1,16))  !  count 4
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV3_9P0_3(W(1,1),W(1,7),GC_25,GC_21,ZERO,FK_ZERO,W(1,17))  !  count 4
      CALL FFV3_9P0_3(W(1,1),W(1,8),GC_25,GC_21,ZERO,FK_ZERO,W(1,18))  !  count 4
      CALL FFV3_9P0_3(W(1,2),W(1,7),GC_25,GC_21,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV3_9P0_3(W(1,2),W(1,8),GC_25,GC_21,ZERO,FK_ZERO,W(1,20))  !  count 4
