...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFS1_2_3(W(1,1),W(1,4),GC_16,GC_12,MDL_MH, ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,3),W(1,2),W(1,5),GC_79,AMP(1))
      CALL FFV2_3_5_9_3(W(1,1),W(1,4),GC_43,GC_40,GC_47,GC_36,MDL_MZ,
     $  ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_7_0(W(1,3),W(1,2),W(1,5),GC_62,GC_69,AMP(2))
      CALL FFV3_9P0_3(W(1,1),W(1,4),GC_25,GC_21,ZERO, FK_ZERO,W(1,5))
