#!/usr/bin/env python3
"""
μLHC _at_3_7_TeV γγ→W+W− : dσ/dM_WW (SM vs EFT) with CMS-style overlay+ratio and counts/dsig modes.
...
def main():
    ...
    ap.add_argument("--out-prefix", default="mww_compare_muLHC_SM_vs_EFT_at_5_3_TeV",
                    help="Output prefix for .png/.pdf/.csv")
    ap.add_argument("--title", default=r"μLHC@3.7 TeV: $p(\gamma)\otimes \mu(\gamma)\to W^+W^-$",
                    help="Plot title.")
