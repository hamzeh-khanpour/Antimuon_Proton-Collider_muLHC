#!/usr/bin/env python3
"""
μLHC _at_5_3_TeV γγ→W+W− : dσ/dM_WW (SM vs EFT) with CMS-style overlay+ratio and counts/dsig modes.
...
def main():
    ...
    ap.add_argument("--title", default=r"μLHC@5.3TeV: $p(\gamma)\otimes \mu(\gamma)\to W^+W^-$",
                    help="Plot title.")
