...
C     
C     Process: a mu+ > h mu+ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,4) /1,-1,-1, 0, 1/
      DATA (NHEL(I,2),I=0,4) /2,-1,-1, 0,-1/
      DATA (NHEL(I,3),I=0,4) /3,-1, 1, 0, 1/
      DATA (NHEL(I,4),I=0,4) /4,-1, 1, 0,-1/
      DATA (NHEL(I,5),I=0,4) /5, 1,-1, 0, 1/
      DATA (NHEL(I,6),I=0,4) /6, 1,-1, 0,-1/
      DATA (NHEL(I,7),I=0,4) /7, 1, 1, 0, 1/
      DATA (NHEL(I,8),I=0,4) /8, 1, 1, 0,-1/
      DATA IDEN/ 4/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WH) 
      ...
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5))  !  count 16
      CALL IXXXXX(P(0,4),MDL_MM,+1,-1*IC(4),W(1,6))  !  count 6
      CALL IXXXXX(P(0,4),MDL_MM,-1,-1*IC(4),W(1,7))  !  count 6
      CALL FFV1_1(W(1,3),W(1,1),GC_3,MDL_MM,FK_ZERO,W(1,8))  !  count 2
      CALL FFV1_1(W(1,3),W(1,2),GC_3,MDL_MM,FK_ZERO,W(1,9))  !  count 2
      CALL FFV1_1(W(1,4),W(1,1),GC_3,MDL_MM,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_1(W(1,4),W(1,2),GC_3,MDL_MM,FK_ZERO,W(1,11))  !  count 2
      CALL FFS4P1N_2(W(1,6), W(1,5), GC_93, TMP(1))
      call CombineAmp(4,
     & (/7,3,5,1/), 
     & (/8,9,10,11/),
     & TMP, W, AMP(1,1))
      CALL FFS4P1N_2(W(1,7), W(1,5), GC_93, TMP(1))
      call CombineAmp(4,
     & (/8,4,6,2/), 
     & (/8,9,10,11/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_2(W(1,6),W(1,1),GC_3,MDL_MM,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1_2(W(1,6),W(1,2),GC_3,MDL_MM,FK_ZERO,W(1,13))  !  count 2
      CALL FFV1_2(W(1,7),W(1,1),GC_3,MDL_MM,FK_ZERO,W(1,14))  !  count 2
      CALL FFV1_2(W(1,7),W(1,2),GC_3,MDL_MM,FK_ZERO,W(1,15))  !  count 2
      CALL FFS4P1N_1(W(1,3), W(1,5), GC_93, TMP(1))
      call CombineAmp(4,
     & (/7,3,8,4/), 
     & (/12,13,14,15/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,4), W(1,5), GC_93, TMP(1))
      call CombineAmp(4,
     & (/5,1,6,2/), 
     & (/12,13,14,15/),
