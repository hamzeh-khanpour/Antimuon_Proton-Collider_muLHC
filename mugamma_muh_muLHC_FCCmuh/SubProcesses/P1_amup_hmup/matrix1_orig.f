...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WH)
      ...
      CALL IXXXXX(P(0,4),MDL_MM,NHEL(4),-1*IC(4),W(1,4))
      CALL FFV1_1(W(1,2),W(1,1),GC_3,MDL_MM, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS4_0(W(1,4),W(1,5),W(1,3),GC_93,AMP(1))
      CALL FFV1_2(W(1,4),W(1,1),GC_3,MDL_MM, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS4_0(W(1,5),W(1,2),W(1,3),GC_93,AMP(2))
